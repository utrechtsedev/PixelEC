...
type RouteParams = {  };
type RouteId = '/(dashboard)/dashboard/categories';
...
type LayoutRouteId = RouteId | "/(dashboard)/dashboard/categories" | "/(dashboard)/dashboard/categories/create" | "/(dashboard)/dashboard/categories/edit/[id]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(dashboard)/dashboard/categories/+layout.server.js').load>>>>>>;
