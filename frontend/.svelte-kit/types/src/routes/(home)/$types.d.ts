...
type LayoutRouteId = RouteId | "/(home)" | "/(home)/(tests)/testpage" | "/(home)/products" | "/(home)/products/1"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(home)/+layout.server.js').load>>>>>>;
