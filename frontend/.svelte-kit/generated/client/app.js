...
export const dictionary = {
		...
		"/(dashboard)/dashboard/products/create": [17,[2,4]],
		"/(dashboard)/dashboard/products/edit/[id]": [18,[2,4]],
		"/(dashboard)/dashboard/settings": [19,[2]],
		"/(home)/products": [22,[5]],
		"/(home)/products/1": [23,[5]],
		"/(home)/(tests)/testpage": [21,[5]]
	};
