...
// Corrected bulkCreate operation with stringified JSON values
await models.StorefrontSettings.bulkCreate([
  ...
  },
  {
    ...
    setting_value: "pixelstore.com", // Already a string, no stringification needed
    value_type: "string",
    category: "general",
  ...
  },
  {
    ...
    setting_value: "modern", // Already a string, no stringification needed
    value_type: "string",
  ...
  },
  {
    ...
    setting_value: JSON.stringify(["#FFF", "#000", "#FFF", "#000"]), // Array needs to be stringified
    value_type: "json",
